...
if __name__ == "__main__":
    ...
    parser.add_argument('--sim-time', type=float, default=0.000001)
    ...
    graphbase = ["SPWRRGraph_10_90_ALL", "SPWRRGraph_90_10_ALL", "SPWRRGraph_30_70_ALL", "SPWRRGraph_70_30_ALL"]
    
    gen = AutomatedTopDatasetGenerator(args.ns3_path, "./datasets/oran-hqos")
