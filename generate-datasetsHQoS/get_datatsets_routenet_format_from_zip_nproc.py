...
def main():
    ...
    ap.add_argument("--results-root", default="./datasets/oran-hqos_merged/test")
    ap.add_argument("--out-root", default="../RouteNet-Fermi/final_set_dataset/oran-hqos_BW40_SCS30/test")
