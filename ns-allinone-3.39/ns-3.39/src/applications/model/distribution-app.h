...
#ifndef DISTRIBUTION_APP_APPLICATION_H
#define DISTRIBUTION_APP_APPLICATION_H
 ...
 * \defgroup POISSON_APP Distributionapp
 *
 ...
 */
class Distributionapp : public Application
{
  public:
    /**
  ...
  private:
    ...
    uint32_t m_pktSizeMax;               //!< Bound on packet size
    uint32_t m_pktSizeMin;               //!< Bound on packet size
    uint8_t m_dscp;                      //!< DSCP value to set in the IP header of generated packets
    double m_scv_tia;
    double m_scv_pkt;
    ...
    std::string m_packetgentype;
    std::string m_arrivalgentype;
    double m_interval;
    Ptr<RandomVariableStream> m_time_id;
    Ptr<RandomVariableStream> m_packet_gen;
