 ...
 * \defgroup POISSON_APP PoissonApplication
 *
...
class PoissonApplication : public Application
{
  ...
  private:
    ...
    uint32_t m_pktSizeBound;             //!< Bound on packet size
    ...
    double m_interval;
    Ptr<ExponentialRandomVariable> m_time_id;
    Ptr<ExponentialRandomVariable> m_packet_gen;
