...
class DatanetAPI:
            ...
            try:
                ...
                while(True):
                    ...
                    if (s._routing_file in self._routings_dic):
                        ...
                        # print("HASTA AQUI 6")
                        # print("Creating routing matrix for file: %s" % (s._routing_file))
                    ...
                    # print("HASTA AQUI 8.1")
                    s._set_topology_object(g)
                    # print("HASTA AQUI 8.2")
    ...
    def _process_flow_results(self, s):
        ...
        for i in range(0,len(r), int(math.sqrt(len(r)))):
            # print("Processing src-dst: %d-%d" % (i//int(math.sqrt(len(r))), int(math.sqrt(len(r)))))
            new_result_row = []
            new_traffic_row = []
            for j in range(i, i+int(math.sqrt(len(r)))):
                # print("Processing src-dst: %d-%d" % (j//int(math.sqrt(len(r))), j%int(math.sqrt(len(r)))))
                dict_result_srcdst = {}
                aux_agg_ = r[j].split(',')
                ...
                for flow in aux_result_flows:
                    # print("Processing results flow: %s" % (flow))
                    dict_result_tmp = {}
                ...
                for flow in aux_traffic_flows:
                    # print("Processing traffic features flow: %s" % (flow))
                    dict_traffic = {}
            ...
            # print("Finished processing src-dst: %d-%d" % (j//int(math.sqrt(len(r))), j%int(math.sqrt(len(r)))))
